...
/datum/preferences/proc/set_new_race(datum/species/new_race, user)
	...
	if(user)
		if(pref_species.desc)
			...
			var/bonus_languages = langs > 1 ? span_info("Racial Language[langs > 2 ? "s" : ""]: [pref_species.get_string_languages()]<br>") : null
			...
			var/description2print  = fieldset_block(span_big("<b>[span_bignotice(pref_species.desc_title)]</b>"), "[pref_species.desc]<br><hr>[bonus_languages][bonus_stats][bonus_traits][mechanics]", "speciesdesc_block")
