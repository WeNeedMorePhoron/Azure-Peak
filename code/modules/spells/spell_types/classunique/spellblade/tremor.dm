...
=======
/datum/telegraphed_strike/spellblade/tremor
>>>>>>> Stashed changes
	damage = 30
	empowered_mult = 2
	push_dist = 1
...
/datum/telegraphed_strike/spellblade/tremor/get_pattern_offsets()
	return list(
...
/datum/telegraphed_strike/spellblade/tremor/on_impact(mob/living/carbon/human/H, facing, atom/movable/visual)
	. = ..()
...
/datum/action/cooldown/spell/telegraphed_strike/spellblade/tremor
	...
	sound = null
	invocations = list("Tremor!")
	engine_type = /datum/telegraphed_strike/spellblade/tremor
