/datum/action/cooldown/spell/conjure_summon/champion
	...
	Its arms and prowess scale with your arcyne standing - those who wield two major aspects call forth steel-clad champions, and a master of the arcyne calls forth blacksteel juggernauts. \
