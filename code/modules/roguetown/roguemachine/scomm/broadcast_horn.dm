...
/obj/structure/broadcast_horn/paid/examine()
	. = ..()
	. += span_info("A noble, burgher, churchman, retinue member, courtier, or university mage can use this for a zenny. Others must insert a ziliqua.")
...
/obj/structure/broadcast_horn/paid/proc/get_broadcast_cost(mob/user)
	...
	if(user_job.department_flag & (NOBLEMEN|BURGHERS|GARRISON|CHURCHMEN|COURTIERS|RETINUE|UNIVERSITY))
