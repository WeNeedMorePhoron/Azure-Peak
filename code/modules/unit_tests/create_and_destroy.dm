...
// Temporarily commenting this out so we can get CI in and working again// ///Delete one of every type, sleep a while, then check to see if anything has gone fucky
