...
<h4>Abilities</h4>
<ul>
<li><b>Shatter</b> — Wind up a heavy blow, then smash a line straight ahead, hurling those struck back a tile. Stops at walls but batters any structure in its path. Empowered: doubles damage.</li>
<li><b>Tremor</b> — Wind up a slam, then erupt the ground in a ring around you, smashing and hurling back everyone adjacent. The ring follows you as you wind it up. Empowered: doubles damage.</li>
