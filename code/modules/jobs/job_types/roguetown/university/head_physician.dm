/datum/job/roguetown/head_physician
	...
	display_order = JDO_HEAD_PHYSICIAN
	...
	outfit = /datum/outfit/job/roguetown/head_physician
	whitelist_req = TRUE
	advclass_cat_rolls = list(CTAG_COURTPHYS = 2)

	give_bank_account = TRUE
	min_pq = 3 //Please don't kill the duke by operating on strong intent. Play physician until you're deserving of the great white beak of doom
	max_pq = null
...
/datum/advclass/head_physician
	...
	tutorial = "You are a master physician and the head of the clinic. \
		...
		You are considered equal in status to the Archmagos, one half of the University. \
		Oversee your clinic and the apothecaries under you."
	outfit = /datum/outfit/job/roguetown/head_physician/basic
...
/datum/outfit/job/roguetown/head_physician
	name = "Head Physician"
	jobtype = /datum/job/roguetown/head_physician

/datum/outfit/job/roguetown/head_physician/basic/pre_equip(mob/living/carbon/human/H)
	..()
