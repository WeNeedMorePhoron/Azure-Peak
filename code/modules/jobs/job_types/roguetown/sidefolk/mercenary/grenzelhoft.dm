...
/datum/advclass/mercenary/grenzelhoft_mage
	...
	subclass_mage_aspects = list("mastery" = FALSE, "major" = 1, "minor" = 2, "utilities" = 6, "allowed_majors" = list(/datum/magic_aspect/pyromancy, /datum/magic_aspect/geomancy, /datum/magic_aspect/ferramancy), "variants" = list(/datum/magic_aspect/pyromancy = "grenzelhoftian", /datum/magic_aspect/geomancy = "grenzelhoftian", /datum/magic_aspect/ferramancy = "grenzelhoftian"), "post_aspect_spells" = list(/datum/action/cooldown/spell/message, /datum/action/cooldown/spell/magicians_brick, /datum/action/cooldown/spell/fire_curtain/thin), "ward" = TRUE)
	subclass_stats = list(
		STATKEY_INT = 3,
		STATKEY_WIL = 3,
		STATKEY_STR = -1,
