...
#define HERESYDESC_NALEDIAN "A symbol of Naledian Psydonic beliefs" //Cause its a foreign faith, unlike Otavan Psydonites, these ones are from much further out
