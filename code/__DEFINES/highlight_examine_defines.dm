...
#define HERESYDESC_VAMPIRE "An unnatural, cursed design that crackles with unholy energies." //Less god ties, more "genuinely what the fuck is this?"
...
#define EXAMINEHIGHLIGHT_HERESYSEVERITY_VAMPIRE 7
