...
#define RITE_COUNTER_CLAIM_DURATION 30 SECONDS  // TESTING: 1 MINUTES

/// Solar Succession
#define SOLAR_REQUIRED_ASSENTS_INSIDER  1    // TESTING: 3
#define SOLAR_REQUIRED_ASSENTS_OUTSIDER 1    // TESTING: 5
