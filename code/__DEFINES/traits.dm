...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_DUALWIELDER = span_info("While wielding two reasonably lightweight weapons with at least Journeyman skill on each, I alternate attacks between them. After five strikes, I'll attack with both at once and gain a brief mobility, accuracy and attack speed bonus. While Dual-Wielding, my Evade is limited, but I have advantage on Parry."),
