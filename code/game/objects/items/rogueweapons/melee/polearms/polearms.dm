...
/obj/item/rogueweapon/halberd/psyhalberd
	...
	desc = "A reliable design that has served humenkind to fell the enemy and defend Psydon's flock - now fitted with a \
	lengthier blade and twin, silver-tipped beaks."
