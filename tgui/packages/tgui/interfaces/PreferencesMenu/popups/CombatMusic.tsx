...
import { Button, Icon, ImageButton, Stack } from 'tgui-core/components';
/**
 * Character Selection
 */
...
const PopupCombatMusicInner = (props: { constantData: ConstantData }) => {
  ...
  return (
    <Stack vertical p={2} mb={4}>
      {Object.values(constant_combat_music).map((music) => (
              ...
              >
                ...
                <Stack fill vertical align="space-between">
                  ...
                  <Stack.Item grow>
                    ...
                    <Stack fill>
                      {/* Name */}
                      <Stack.Item basis="25%" fontSize={1.2} textAlign="left">
                        {music.shortname ? (
